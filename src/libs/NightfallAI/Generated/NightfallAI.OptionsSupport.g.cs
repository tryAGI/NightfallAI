...
namespace NightfallAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::NightfallAI.AutoSDKRetryOptions Retry { get; set; } = new global::NightfallAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::NightfallAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::NightfallAI.IAutoSDKHook>();
        ...
        public global::NightfallAI.AutoSDKClientOptions AddHook(
            global::NightfallAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::NightfallAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::NightfallAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::NightfallAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::NightfallAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::NightfallAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::NightfallAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::NightfallAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::NightfallAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::NightfallAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::NightfallAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::NightfallAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::NightfallAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::NightfallAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::NightfallAI.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::NightfallAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::NightfallAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::NightfallAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        internal static global::NightfallAI.AutoSDKHookContext CreateHookContext(
            ...
            global::NightfallAI.AutoSDKClientOptions clientOptions,
            global::NightfallAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::NightfallAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::NightfallAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::NightfallAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::NightfallAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::NightfallAI.IAutoSDKHook, global::NightfallAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::NightfallAI.AutoSDKHookContext context)
        {
